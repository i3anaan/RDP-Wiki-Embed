...
class RDP_WIKI_EMBED_SHORTCODE_POPUP {
    ...
    public static function renderPopupForm(){
        ...
        echo '<tr>';
        echo '<th valign="top" class="label" scope="row">';
        echo '<span class="alignleft"><label for="rdp-we-embed-section">';
        _e('Section', 'rdp-wiki-embed');
        echo '</label></span>';
        echo '</th>';
        echo '<td class="field"><input type="text"  id="rdp_we_embed_section"></td>';
        echo '</tr> ';

        echo '<tr>';
        echo '<th valign="top" class="label" scope="row">';
        echo '<span class="alignleft"><label for="rdp-we-embed-section">';
        _e('Section instructions', 'rdp-wiki-embed');
        echo '</label></span>';
        echo '</th>';
        echo '<td class="field"><span>Use inspector (right mouse button) on Header of section, then copy the id of the "span" element inside of the "h2" element. Leave empty for entire page.</span></td>';
        echo '</tr>';
